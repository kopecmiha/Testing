...
from .views import SpecializationViewSet, CompetenceViewSet, DisciplineViewSet, CompetenceSetByDiscipline, \
    CompetenceSetBySpecialization
...
urlpatterns = [
    ...
    path('get_competences_by_discipline/<int:discipline_id>/', CompetenceSetByDiscipline.as_view()),
